...
from app.schemas.workout_charts import (WorkoutProgressAPIResponse ,WorkoutProgressResponse,WorkoutProgressSummary,MuscleDistribution , Tip)
...
async def get_workout_progress_summary(user_id: str = Depends(get_current_user_id)):
    ...
    try:
        ...
        # Constructing structured response based on Pydantic models
